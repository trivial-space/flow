import { create } from '../../../lib/utils/entity-reference';
import * as types from '../../../lib/runtime-types';
import * as runtime from '../../../lib/runtime';
describe('flow entity reference', function () {
    var sys, val, json, stream, asyncStream, streamStart, asyncStreamStart, addToFlow;
    beforeEach(function () {
        sys = runtime.create();
...
//# sourceMappingURL=entity-reference-test.js.map